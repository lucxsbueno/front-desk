...
class o {
    ...
    e.on("pointerDown", (o) => {
      ...
      e.on("close", () => {
        t(e.currSlide.content) &&
          ((e.options.showHideAnimationType &&
            "zoom" !== e.options.showHideAnimationType) ||
            (e.options.showHideAnimationType = "fade"),
  ...
  onContentDestroy({ content: e }) {
    t(e) &&
      e._videoPosterImg &&
      ((e._videoPosterImg.onload = e._videoPosterImg.onerror = null),
      (e._videoPosterImg = null));
  }
  onContentResize(e) {
    if (t(e.content)) {
      e.preventDefault();
      ...
      if (
        (n.element &&
          ((n.element.style.width = t + "px"),
          (n.element.style.height = o + "px")),
        n.slide && n.slide.placeholder)
      ) {
  ...
  onContentLoad(e) {
    ...
    if (t(e.content) && (e.preventDefault(), !o.element)) {
      if (
        ((o.state = "loading"),
        (o.type = "video"),
        (o.element = document.createElement("video")),
        this.options.videoAttributes)
      )
        for (let e in this.options.videoAttributes)
          o.element.setAttribute(e, this.options.videoAttributes[e] || "");
