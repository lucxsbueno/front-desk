          ...
          <div className="row d-flex justify-content-center">
            <div className="col-md-10">
              <div className="account__avatar">
                <img
                  src="https://cdn.dribbble.com/users/230875/screenshots/12163492/media/9ccf7b00b9933758d84c8f6b2bf9185f.jpg?compress=1&resize=400x300"
                  alt=""
              ...
              <div className="account__nav">
                <ul className="account__menu">
                  <li className="account__item">
                    <NavLink to="/minha-conta" className="account__link">
                      Histórico de ligações
                    </NavLink>
                  </li>

                  <li>
                    <NavLink to="presets" className="account__link">
                      Presets
                    </NavLink>
                  </li>

                  <li>
                    <NavLink to="tags" className="account__link">
                      Tags
                    </NavLink>
                  </li>
                </ul>
